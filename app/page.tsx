...
const jargonDict = [
  ...
  { keywords: ["options", "put options", "ออปชัน"], word: "Options / Put Options", desc: "เครื่องมือตกลงซื้อขายล่วงหน้า ส่วน Put Option คล้ายๆ การซื้อประกัน เผื่อหุ้นตกเราก็ยังขายได้ในราคาที่ตกลงไว้" },
  ...
  { keywords: ["roi", "return on investment", "อัตราผลตอบแทน"], word: "ROI (Return on Investment)", desc: "ผลตอบแทนจากการลงทุน (คิดเป็นเปอร์เซ็นต์) เพื่อดูว่าที่ลงเงินหรือลงแรงไปนั้น มันคุ้มค่ากลับมามากน้อยแค่ไหน" },
  ...
  { keywords: ["personal branding", "สร้างตัวตน", "สร้างแบรนด์"], word: "Personal Branding", desc: "การสร้างตัวตนออนไลน์ให้คนจำได้ว่าเราเป็นใคร เก่งเรื่องอะไร" },
  ...
  // แก้เป็นแบบนี้ (เพิ่ม variations เข้าไป) 👇
{ keywords: ["the gap and the gain", "gap and gain", "the gap & the gain", "gap & gain", "the gap"], word: "The Gap and The Gain", desc: "แนวคิดการมองความสำเร็จ โดยเน้นดูว่าเราเดินมาไกลแค่ไหนแล้ว (Gain) แทนที่จะมองแต่ระยะทางที่เหลือ (Gap)" },
 ...
 { keywords: ["subscription", "รายเดือน", "ซับสคริปชัน", "สตรีมมิ่ง"], word: "Subscription", desc: "ระบบจ่ายเงินรายเดือนเพื่อใช้บริการ (เช่น Netflix, Spotify) ถ้ามีเยอะเกินจะกลายเป็นรูรั่วทางการเงิน" },
  ...
  { keywords: ["target date", "ทาร์เก็ตเดท"], word: "Target Date Fund", desc: "กองทุนรวมที่จัดพอร์ตให้ตาม 'ปีที่เราจะเกษียณ' ยิ่งอายุน้อยจะเน้นหุ้นเสี่ยงสูง พออายุมากใกล้เกษียณ ระบบจะสลับไปลงทุนในของปลอดภัยให้อัตโนมัติ" },
  // 💡 หมวด: ศัพท์ตกหล่นที่ซ่อนอยู่ใน Scenarios
  { keywords: ["growth stock", "หุ้น growth", "หุ้นเติบโต"], word: "Growth Stock (หุ้นเติบโต)", desc: "หุ้นของบริษัทที่มีแนวโน้มรายได้และกำไรเติบโตสูงกว่าค่าเฉลี่ยของตลาดอย่างรวดเร็ว มักจะไม่ค่อยจ่ายปันผลเพราะต้องเอาเงินไปลงทุนขยายกิจการต่อ" },
  { keywords: ["specific knowledge", "ความรู้เฉพาะทาง"], word: "Specific Knowledge", desc: "ทักษะเฉพาะตัวที่เกิดจากความหลงใหลและประสบการณ์ของเราเอง เป็นสิ่งที่โรงเรียนสอนไม่ได้ และ AI หรือคนอื่นก็ลอกเลียนแบบได้ยาก (แนวคิดจาก Naval Ravikant)" },
  { keywords: ["pay yourself first"], word: "Pay Yourself First", desc: "กฎเหล็กของการออมเงิน คือเมื่อรายได้เข้ามาปุ๊บ ให้หักเงินไปออมหรือลงทุนเป็น 'อันดับแรก' ก่อนที่จะเอาไปจ่ายบิลหรือช้อปปิ้งเสมอ" },
  { keywords: ["dying with zero"], word: "Dying with Zero", desc: "แนวคิดการใช้ชีวิตให้คุ้มค่าที่สุด โดยวางแผนใช้เงินที่หามาได้ซื้อ 'ประสบการณ์' ตามช่วงวัย แทนที่จะเก็บสะสมไว้เฉยๆ จนตายแล้วไม่ได้ใช้" },
  { keywords: ["ubi", "universal basic income"], word: "UBI (Universal Basic Income)", desc: "แนวคิดรัฐสวัสดิการที่จะแจกเงินให้ประชาชนทุกคนเท่าๆ กันทุกเดือนโดยไม่มีเงื่อนไข เพื่อให้ทุกคนอยู่รอดได้ในยุคที่ AI อาจแย่งงานมนุษย์" },
  { keywords: ["emerging market", "ตลาดเกิดใหม่"], word: "Emerging Market", desc: "ตลาดหุ้นในกลุ่มประเทศกำลังพัฒนา (เช่น อินเดีย เวียดนาม หรือไทย) มีโอกาสเติบโตสูงมาก แต่ก็มีความผันผวนและเสี่ยงสูงกว่าประเทศพัฒนาแล้ว" },
  { keywords: ["art toy", "อาร์ตทอย"], word: "Art Toy", desc: "ของเล่นของสะสมที่ออกแบบโดยศิลปิน ผลิตมาจำนวนจำกัด ทำให้บางคอลเลกชันเกิดความต้องการสูงจนราคาพุ่งขึ้นหลายเท่าตัวในตลาดรีเซล (Resell)" }
...
const getCurrentJargons = () => {
  ...
  const textPool = [
    currentQ.npcName,
    currentQ.role, // ✨ เพิ่มบรรทัดนี้เข้าไป
    currentQ.message,
