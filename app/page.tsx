...
// --- เพิ่มเติมจาก Result Data (Personas) ---
  { keywords: ["mixed fund", "กองทุนผสม"], word: "Mixed Fund (กองทุนผสม)", desc: "กองทุนที่กระจายเงินลงทุนทั้งในหุ้นและตราสารหนี้ในกองเดียว เพื่อลดความผันผวน" },
 
  { keywords: ["stop-loss", "จุดตัดขาดทุน", "คัทลอส"], word: "Stop-Loss (จุดตัดขาดทุน)", desc: "การตั้งจุดขายล่วงหน้าเพื่อจำกัดความเสียหาย ไม่ให้พอร์ตพังไปมากกว่าที่กำหนด" },
  { keywords: ["over-optimization", "สูตรสำเร็จ"], word: "Over-Optimization", desc: "การพยายามปรับจูนระบบให้สมบูรณ์แบบเกินไปจนยึดติดกับตัวเลขในอดีต ซึ่งอาจใช้ไม่ได้กับอนาคต" },
  ...
  { keywords: ["minimum payment", "จ่ายขั้นต่ำ"], word: "Minimum Payment", desc: "การชำระหนี้บัตรเครดิตเพียงบางส่วน ซึ่งจะนำไปสู่การสะสมของดอกเบี้ยทบต้นฝั่งรายจ่าย" },
  { keywords: ["skill up", "เพิ่มทักษะ", "อัปสกิล"], word: "Skill Up", desc: "การลงทุนในความรู้หรือทักษะใหม่ๆ เพื่อเพิ่มขีดความสามารถในการหาเงิน" },
