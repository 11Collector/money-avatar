...
const jargonDict = [
 ...
 { 
  ...
  { keywords: ["algorithm", "อัลกอริทึม"], word: "Algorithm (อัลกอริทึม)", desc: "ชุดคำสั่งและตรรกะของแพลตฟอร์มโซเชีลมีเดีย ที่ใช้คำนวณพฤติกรรมเพื่อคัดกรองและนำเสนอเนื้อหาให้ตรงกับความสนใจของผู้ใช้งาน" },
  ...
  { keywords: ["hard asset", "สินทรัพย์แข็ง"], word: "Hard Asset (สินทรัพย์ที่มีมูลค่าในตัวเอง)", desc: "สินทรัพย์ที่มีตัวตนหรือมีคุณสมบัติจำกัดในทางคณิตศาสตร์ (เช่น ที่ดิน ทองคำ) ซึ่งทนทานต่อการเสื่อมค่าและไม่สามารถถูกสร้างขึ้นใหม่ได้ง่ายๆ ด้วยนโยบายทางการเงิน" },
  { keywords: ["digital gold", "ทองคำดิจิทัล"], word: "Digital Gold (ทองคำดิจิทัล)", desc: "สถานะที่ถูกยกย่องให้แก่ Bitcoin (BTC) เนื่องจากมีคุณสมบัติคล้ายทองคำ คือมีจำนวนจำกัด ไม่สามารถพิมพ์เพิ่มได้ และใช้เป็นสินทรัพย์รักษามูลค่า (Store of Value) หลบภัยจากเงินเฟ้อ" },
